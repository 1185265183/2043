...
<table class="table table-bordered table-hover " style=" table-layout: fixed;">
    ...
    <c:forEach var="project" items="${projectList}" varStatus="state">
        ...
        <td>
              <div class="btn-group">
					<button type="button" class="btn btn-default  btn-primary" onclick="javascrtpt:window.location.href='${pageContext.request.contextPath}/project/detectProject/${project.projectid}'">解析</button>
			</div>
        </td>
    	</tr>
    	</c:forEach>
