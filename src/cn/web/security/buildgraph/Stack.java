 ...
 * collection stores elements with a last-in-first-out (LIFO) order. The
 * interface defines methods for insertion (push), extraction (pop) and
 * inspection (peek).
 * <p>
 * The remove() method removes and returns the element at the top of the stack
 * or throws an exception if the stack is empty. The peek() method returns the
 * value of the element at the top of the stack, but does not remove it.
 * <p>
